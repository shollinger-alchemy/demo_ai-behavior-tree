...
namespace Alchemy.AI {
    public class PerceptionAgeGT<T> : PerceptionConditionalNode<T>
    {
        private Vector2 secondsUntilAgedRange;

        public PerceptionAgeGT(Vector2 secondsUntilAgedRange, bool shouldMatch = true, string actionId = null, int instanceId = -1) : base(shouldMatch, actionId, instanceId){
